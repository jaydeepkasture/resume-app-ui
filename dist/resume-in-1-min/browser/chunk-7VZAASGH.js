import {
  ...
  Validators,
  ɵNgNoValidate
} from "./chunk-2WHLHBFK.js";
import {
  AuthService
} from "./chunk-LJT23RN2.js";
import {
  ActivatedRoute,
  CommonModule,
  NgIf,
...
var LoginComponent = class _LoginComponent {
  ...
  initializeGoogleSignIn() {
    ...
    if (buttonDiv) {
      google.accounts.id.renderButton(buttonDiv, { theme: "outline", size: "large", width: "100%", text: "continue_with" });
    }
  }
  ...
  onSubmit() {
    ...
    console.log("\u{1F4E4} Sending credentials:", credentials);
    console.log("\u{1F4E4} Credentials type:", typeof credentials);
    console.log("\u{1F4E4} Credentials JSON:", JSON.stringify(credentials));
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LoginComponent, selectors: [["app-login"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 43, vars: 14, consts: [[1, "auth-container"], [1, "auth-card"], [1, "auth-header"], ["src", "assets/logo.png", "alt", "Resume in 1 Min", 1, "auth-logo"], [1, "auth-form", 3, "ngSubmit", "formGroup"], ["class", "alert alert-error", 4, "ngIf"], [1, "form-group"], ["for", "email"], ["type", "email", "id", "email", "formControlName", "email", "placeholder", "Enter your email", 1, "form-control"], ["class", "invalid-feedback", 4, "ngIf"], ["for", "password"], [1, "password-input-wrapper"], ["id", "password", "formControlName", "password", "placeholder", "Enter your password", 1, "form-control", 3, "type"], ["type", "button", "tabindex", "-1", 1, "password-toggle", 3, "click"], ["width", "20", "height", "20", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2", 4, "ngIf"], [1, "form-options"], [1, "checkbox-label"], ["type", "checkbox", "formControlName", "rememberMe"], ["routerLink", "/forgot-password", 1, "forgot-link"], ["type", "submit", 1, "btn", "btn-primary", 3, "disabled"], [4, "ngIf"], ["class", "loading-spinner", 4, "ngIf"], [1, "auth-divider"], ["id", "google-btn"], [1, "auth-footer"], ["routerLink", "/register"], [1, "alert", "alert-error"], ["width", "20", "height", "20", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2"], ["cx", "12", "cy", "12", "r", "10"], ["x1", "12", "y1", "8", "x2", "12", "y2", "12"], ["x1", "12", "y1", "16", "x2", "12.01", "y2", "16"], [1, "invalid-feedback"], ["d", "M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"], ["cx", "12", "cy", "12", "r", "3"], ["d", "M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"], ["x1", "1", "y1", "1", "x2", "23", "y2", "23"], [1, "loading-spinner"], ["cx", "12", "cy", "12", "r", "10", "opacity", "0.25"], ["d", "M12 2a10 10 0 0 1 10 10", "opacity", "0.75"]], template: function LoginComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275element(37, "div", 23);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(38, "div", 24)(39, "p");
        \u0275\u0275text(40, "Don't have an account? ");
...
//# sourceMappingURL=chunk-7VZAASGH.js.map
