...
function ResetPasswordComponent_form_8_div_1_Template(rf, ctx) {
  if (rf & 1) {
...
function ResetPasswordComponent_form_8__svg_svg_8_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
...
function ResetPasswordComponent_form_8__svg_svg_9_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(0, "svg", 23);
    \u0275\u0275element(1, "path", 29)(2, "line", 30);
    \u0275\u0275elementEnd();
  }
}
function ResetPasswordComponent_form_8_div_10_span_1_Template(rf, ctx) {
  if (rf & 1) {
...
function ResetPasswordComponent_form_8_div_10_span_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span");
...
function ResetPasswordComponent_form_8_div_10_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 31);
    \u0275\u0275template(1, ResetPasswordComponent_form_8_div_10_span_1_Template, 2, 0, "span", 20)(2, ResetPasswordComponent_form_8_div_10_span_2_Template, 2, 0, "span", 20);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function ResetPasswordComponent_form_8__svg_svg_17_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(0, "svg", 23);
    \u0275\u0275element(1, "path", 27)(2, "circle", 28);
...
function ResetPasswordComponent_form_8__svg_svg_18_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(0, "svg", 23);
    \u0275\u0275element(1, "path", 29)(2, "line", 30);
...
function ResetPasswordComponent_form_8_div_19_span_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span");
...
function ResetPasswordComponent_form_8_div_19_span_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span");
...
function ResetPasswordComponent_form_8_div_19_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 31);
    \u0275\u0275template(1, ResetPasswordComponent_form_8_div_19_span_1_Template, 2, 0, "span", 20)(2, ResetPasswordComponent_form_8_div_19_span_2_Template, 2, 0, "span", 20);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function ResetPasswordComponent_form_8_span_21_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span");
...
function ResetPasswordComponent_form_8_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, ResetPasswordComponent_form_8_div_1_Template, 6, 1, "div", 9);
    ...
    \u0275\u0275listener("click", function ResetPasswordComponent_form_8_Template_button_click_7_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.togglePasswordVisibility("password"));
    });
    \u0275\u0275template(8, ResetPasswordComponent_form_8__svg_svg_8_Template, 3, 0, "svg", 15)(9, ResetPasswordComponent_form_8__svg_svg_9_Template, 3, 0, "svg", 15);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(10, ResetPasswordComponent_form_8_div_10_Template, 3, 2, "div", 16);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "div", 10)(12, "label", 17);
    \u0275\u0275text(13, "Confirm Password");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(14, "div", 12);
    \u0275\u0275element(15, "input", 18);
    \u0275\u0275elementStart(16, "button", 14);
    \u0275\u0275listener("click", function ResetPasswordComponent_form_8_Template_button_click_16_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.togglePasswordVisibility("confirmPassword"));
    });
    \u0275\u0275template(17, ResetPasswordComponent_form_8__svg_svg_17_Template, 3, 0, "svg", 15)(18, ResetPasswordComponent_form_8__svg_svg_18_Template, 3, 0, "svg", 15);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(19, ResetPasswordComponent_form_8_div_19_Template, 3, 2, "div", 16);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(20, "button", 19);
    \u0275\u0275template(21, ResetPasswordComponent_form_8_span_21_Template, 2, 0, "span", 20)(22, ResetPasswordComponent_form_8_span_22_Template, 5, 0, "span", 21);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function ResetPasswordComponent_div_9_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 35)(1, "div", 22);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(2, "svg", 23);
    \u0275\u0275element(3, "circle", 24)(4, "line", 25)(5, "line", 26);
    \u0275\u0275elementEnd();
    \u0275\u0275text(6);
    \u0275\u0275elementEnd();
    \u0275\u0275namespaceHTML();
...
function ResetPasswordComponent_div_10_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(3, "path", 40)(4, "polyline", 41);
    \u0275\u0275elementEnd()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(5, "h2");
    \u0275\u0275text(6, "Success!");
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ResetPasswordComponent, selectors: [["app-reset-password"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 12, vars: 4, consts: [[1, "auth-container"], [1, "auth-card"], [1, "auth-header"], ["src", "assets/logo.png", "alt", "Resume in 1 Min", 1, "auth-logo"], ["class", "auth-form", 3, "formGroup", "ngSubmit", 4, "ngIf"], ["class", "error-state", 4, "ngIf"], ["class", "success-message", 4, "ngIf"], ["class", "auth-footer", 4, "ngIf"], [1, "auth-form", 3, "ngSubmit", "formGroup"], ["class", "alert alert-error", 4, "ngIf"], [1, "form-group"], ["for", "password"], [1, "password-input-wrapper"], ["id", "password", "formControlName", "password", "placeholder", "Enter new password", 1, "form-control", 3, "type"], ["type", "button", "tabindex", "-1", 1, "password-toggle", 3, "click"], ["width", "20", "height", "20", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2", 4, "ngIf"], ["class", "invalid-feedback", 4, "ngIf"], ["for", "confirmPassword"], ["id", "confirmPassword", "formControlName", "confirmPassword", "placeholder", "Re-enter password", 1, "form-control", 3, "type"], ["type", "submit", 1, "btn", "btn-primary", 3, "disabled"], [4, "ngIf"], ["class", "loading-spinner", 4, "ngIf"], [1, "alert", "alert-error"], ["width", "20", "height", "20", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2"], ["cx", "12", "cy", "12", "r", "10"], ["x1", "12", "y1", "8", "x2", "12", "y2", "12"], ["x1", "12", "y1", "16", "x2", "12.01", "y2", "16"], ["d", "M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"], ["cx", "12", "cy", "12", "r", "3"], ["d", "M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"], ["x1", "1", "y1", "1", "x2", "23", "y2", "23"], [1, "invalid-feedback"], [1, "loading-spinner"], ["cx", "12", "cy", "12", "r", "10", "opacity", "0.25"], ["d", "M12 2a10 10 0 0 1 10 10", "opacity", "0.75"], [1, "error-state"], ["routerLink", "/forgot-password", 1, "btn", "btn-primary"], [1, "success-message"], [1, "success-icon"], ["width", "48", "height", "48", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2"], ["d", "M22 11.08V12a10 10 0 1 1-5.93-9.14"], ["points", "22 4 12 14.01 9 11.01"], ["routerLink", "/login", 1, "btn", "btn-primary"], [1, "auth-footer"], ["routerLink", "/login"]], template: function ResetPasswordComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275elementEnd()();
        \u0275\u0275template(8, ResetPasswordComponent_form_8_Template, 23, 17, "form", 4)(9, ResetPasswordComponent_div_9_Template, 9, 1, "div", 5)(10, ResetPasswordComponent_div_10_Template, 11, 1, "div", 6)(11, ResetPasswordComponent_div_11_Template, 5, 0, "div", 7);
        \u0275\u0275elementEnd()();
      }
      if (rf & 2) {
        \u0275\u0275advance(8);
