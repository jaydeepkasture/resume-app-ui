...
import {
  ...
  NgControlStatus,
  NgModel
} from "./chunk-4MOKHIT5.js";
import {
  HttpService
} from "./chunk-NQBNL4V3.js";
import {
  CommonModule,
  EventEmitter,
  HttpClient,
...
function ChatSidebarComponent_div_16_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r2.uploadSlogan, " ");
  }
}
...
function ChatSidebarComponent_div_28_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(2, "circle", 18)(3, "line", 51)(4, "line", 52);
    \u0275\u0275elementEnd();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(5, "p");
    \u0275\u0275text(6);
...
function ChatSidebarComponent_div_29_div_1_h4_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "h4", 70);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function ChatSidebarComponent_div_29_div_1_input_7_Template(rf, ctx) {
  if (rf & 1) {
    const _r8 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "input", 71);
    \u0275\u0275twoWayListener("ngModelChange", function ChatSidebarComponent_div_29_div_1_input_7_Template_input_ngModelChange_0_listener($event) {
      \u0275\u0275restoreView(_r8);
      const ctx_r2 = \u0275\u0275nextContext(3);
      \u0275\u0275twoWayBindingSet(ctx_r2.editingTitle, $event) || (ctx_r2.editingTitle = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275listener("click", function ChatSidebarComponent_div_29_div_1_input_7_Template_input_click_0_listener($event) {
      \u0275\u0275restoreView(_r8);
      return \u0275\u0275resetView($event.stopPropagation());
    })("keydown", function ChatSidebarComponent_div_29_div_1_input_7_Template_input_keydown_0_listener($event) {
      \u0275\u0275restoreView(_r8);
      const session_r7 = \u0275\u0275nextContext().$implicit;
...
function ChatSidebarComponent_div_29_div_1_button_10_Template(rf, ctx) {
  if (rf & 1) {
    const _r9 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 72);
    \u0275\u0275listener("click", function ChatSidebarComponent_div_29_div_1_button_10_Template_button_click_0_listener($event) {
      \u0275\u0275restoreView(_r9);
      const session_r7 = \u0275\u0275nextContext().$implicit;
      const ctx_r2 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275element(2, "path", 74)(3, "path", 75);
    \u0275\u0275elementEnd()();
  }
}
function ChatSidebarComponent_div_29_div_1_button_11_Template(rf, ctx) {
  if (rf & 1) {
    const _r10 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 76);
    \u0275\u0275listener("click", function ChatSidebarComponent_div_29_div_1_button_11_Template_button_click_0_listener($event) {
      \u0275\u0275restoreView(_r10);
      const session_r7 = \u0275\u0275nextContext().$implicit;
      const ctx_r2 = \u0275\u0275nextContext(2);
...
function ChatSidebarComponent_div_29_div_1_button_12_Template(rf, ctx) {
  if (rf & 1) {
    const _r11 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 78);
    \u0275\u0275listener("click", function ChatSidebarComponent_div_29_div_1_button_12_Template_button_click_0_listener($event) {
      \u0275\u0275restoreView(_r11);
      const ctx_r2 = \u0275\u0275nextContext(3);
    ...
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(1, "svg", 73);
    \u0275\u0275element(2, "line", 79)(3, "line", 80);
    \u0275\u0275elementEnd()();
  }
}
function ChatSidebarComponent_div_29_div_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 56);
    \u0275\u0275listener("click", function ChatSidebarComponent_div_29_div_1_Template_div_click_0_listener() {
    ...
    \u0275\u0275template(6, ChatSidebarComponent_div_29_div_1_h4_6_Template, 2, 1, "h4", 61)(7, ChatSidebarComponent_div_29_div_1_input_7_Template, 1, 1, "input", 62);
    \u0275\u0275elementStart(8, "p", 63);
    \u0275\u0275text(9);
    \u0275\u0275elementEnd()()();
    \u0275\u0275template(10, ChatSidebarComponent_div_29_div_1_button_10_Template, 4, 0, "button", 64)(11, ChatSidebarComponent_div_29_div_1_button_11_Template, 3, 0, "button", 65)(12, ChatSidebarComponent_div_29_div_1_button_12_Template, 4, 0, "button", 66);
    \u0275\u0275elementStart(13, "button", 67);
    \u0275\u0275listener("click", function ChatSidebarComponent_div_29_div_1_Template_button_click_13_listener($event) {
      const session_r7 = \u0275\u0275restoreView(_r6).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275element(15, "polyline", 68)(16, "path", 69);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
...
function ChatSidebarComponent_div_29_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, ChatSidebarComponent_div_29_div_1_Template, 17, 6, "div", 55);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
...
function ChatSidebarComponent_div_30_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function ChatSidebarComponent_div_30_Template_button_click_7_listener() {
      \u0275\u0275restoreView(_r12);
      const ctx_r2 = \u0275\u0275nextContext();
...
function ChatSidebarComponent_div_31_Template(rf, ctx) {
  if (rf & 1) {
    const _r13 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 84)(1, "button", 85);
    \u0275\u0275listener("click", function ChatSidebarComponent_div_31_Template_button_click_1_listener() {
      \u0275\u0275restoreView(_r13);
      const ctx_r2 = \u0275\u0275nextContext();
...
function ChatSidebarComponent_div_32_Template(rf, ctx) {
  if (rf & 1) {
...
function ChatSidebarComponent_div_48_Template(rf, ctx) {
  if (rf & 1) {
    const _r14 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 88)(1, "button", 89);
    \u0275\u0275listener("click", function ChatSidebarComponent_div_48_Template_button_click_1_listener() {
      \u0275\u0275restoreView(_r14);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.toggleSidebar());
    });
    ...
    \u0275\u0275element(3, "rect", 23)(4, "line", 24)(5, "polyline", 91);
    \u0275\u0275elementEnd()()();
  }
}
function ChatSidebarComponent__svg_svg_50_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(0, "svg", 90);
    \u0275\u0275element(1, "line", 92)(2, "line", 93)(3, "line", 94);
    \u0275\u0275elementEnd();
  }
}
function ChatSidebarComponent__svg_svg_51_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(0, "svg", 90);
    \u0275\u0275element(1, "line", 79)(2, "line", 80);
    \u0275\u0275elementEnd();
  }
}
var ChatSidebarComponent = class _ChatSidebarComponent {
  constructor(httpService, authService, benefitsService, router) {
    ...
    this.uploadSlogan = "";
    this.uploadSlogans = [
      "Feeding your resume to the AI machine... \u{1F916}\u{1F4DC}",
      "Gaining incredible insights from your experience... \u{1F9E0}\u{1F4BC}",
      "Cooking up some tailored improvements... \u{1F373}\u2728",
      "Scanning for superpowers... \u{1F9B8}\u200D\u2642\uFE0F\u{1F50E}",
      "Crunching action verbs and keywords... \u{1F4AA}\u{1F4CA}",
      "Our robots are reading your career journey... \u{1F916}\u{1F4D6}",
      "Prepping the magic enhancement tools... \u{1FA84}\u{1F6E0}\uFE0F"
    ];
  }
  ngOnInit() {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ChatSidebarComponent, selectors: [["app-chat-sidebar"]], outputs: { chatSelected: "chatSelected", sidebarToggled: "sidebarToggled" }, standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 52, vars: 23, consts: [["fileInput", ""], [1, "sidebar-container"], ["class", "sidebar-overlay", 3, "click", 4, "ngIf"], [1, "sidebar"], [1, "sidebar-header"], [1, "header-actions"], [1, "upload-container"], ["type", "file", "accept", ".docx,.pdf,.doc", 2, "display", "none", 3, "change"], ["title", "Upload Resume", 1, "sidebar-action-btn", "upload-btn", 3, "click", "disabled"], ["width", "18", "height", "18", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2"], ["d", "M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"], [1, "upload-arrow"], ["points", "17 8 12 3 7 8"], ["x1", "12", "y1", "3", "x2", "12", "y2", "15"], [1, "btn-text"], ["class", "upload-slogan-popup", 4, "ngIf"], ["title", "Upload existing resume will we enhance it or you can continue with our templates", 1, "info-icon-container"], ["width", "16", "height", "16", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2"], ["cx", "12", "cy", "12", "r", "10"], ["x1", "12", "y1", "16", "x2", "12", "y2", "12"], ["x1", "12", "y1", "8", "x2", "12.01", "y2", "8"], ["title", "Close Sidebar", 1, "close-sidebar-btn", 3, "click"], ["width", "20", "height", "20", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2"], ["x", "3", "y", "3", "width", "18", "height", "18", "rx", "2", "ry", "2"], ["x1", "9", "y1", "3", "x2", "9", "y2", "21"], [1, "sessions-list"], ["class", "loading-state", 4, "ngIf"], ["class", "error-state", 4, "ngIf"], ["class", "sessions", 4, "ngIf"], ["class", "empty-state", 4, "ngIf"], ["class", "load-more", 4, "ngIf"], ["class", "loading-more", 4, "ngIf"], [1, "sidebar-footer"], [1, "user-profile", 3, "click"], [1, "user-avatar"], [1, "user-info"], [1, "user-name"], [1, "user-email-label"], ["title", "Sign Out", 1, "sign-out-btn", 3, "click"], ["d", "M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"], ["points", "16 17 21 12 16 7"], ["x1", "21", "y1", "12", "x2", "9", "y2", "12"], ["class", "collapsed-sidebar", 4, "ngIf"], [1, "mobile-toggle", 3, "click"], ["width", "24", "height", "24", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2", 4, "ngIf"], [1, "sidebar-overlay", 3, "click"], [1, "upload-slogan-popup"], [1, "loading-state"], [1, "spinner"], [1, "error-state"], ["width", "48", "height", "48", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2"], ["x1", "12", "y1", "8", "x2", "12", "y2", "12"], ["x1", "12", "y1", "16", "x2", "12.01", "y2", "16"], [1, "retry-btn", 3, "click"], [1, "sessions"], ["class", "session-item", 3, "click", 4, "ngFor", "ngForOf"], [1, "session-item", 3, "click"], [1, "session-content"], [1, "session-icon"], ["d", "M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"], [1, "session-info"], ["class", "session-title", 4, "ngIf"], ["type", "text", "class", "title-input", "autofocus", "", 3, "ngModel", "ngModelChange", "click", "keydown", 4, "ngIf"], [1, "session-date"], ["class", "edit-btn", "title", "Rename chat", 3, "click", 4, "ngIf"], ["class", "save-btn", "title", "Save", 3, "click", 4, "ngIf"], ["class", "cancel-btn", "title", "Cancel", 3, "click", 4, "ngIf"], ["title", "Delete chat", 1, "delete-btn", 3, "click"], ["points", "3 6 5 6 21 6"], ["d", "M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"], [1, "session-title"], ["type", "text", "autofocus", "", 1, "title-input", 3, "ngModelChange", "click", "keydown", "ngModel"], ["title", "Rename chat", 1, "edit-btn", 3, "click"], ["width", "14", "height", "14", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2"], ["d", "M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"], ["d", "M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"], ["title", "Save", 1, "save-btn", 3, "click"], ["points", "20 6 9 17 4 12"], ["title", "Cancel", 1, "cancel-btn", 3, "click"], ["x1", "18", "y1", "6", "x2", "6", "y2", "18"], ["x1", "6", "y1", "6", "x2", "18", "y2", "18"], [1, "empty-state"], ["width", "64", "height", "64", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "1.5"], [1, "create-first-btn", 3, "click"], [1, "load-more"], [1, "load-more-btn", 3, "click"], [1, "loading-more"], [1, "spinner-small"], [1, "collapsed-sidebar"], ["title", "Open Sidebar", 1, "expand-btn", 3, "click"], ["width", "24", "height", "24", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2"], ["points", "15 9 15 15"], ["x1", "3", "y1", "12", "x2", "21", "y2", "12"], ["x1", "3", "y1", "6", "x2", "21", "y2", "6"], ["x1", "3", "y1", "18", "x2", "21", "y2", "18"]], template: function ChatSidebarComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275element(12, "polyline", 12)(13, "line", 13);
        \u0275\u0275elementEnd()();
        \u0275\u0275namespaceHTML();
        \u0275\u0275elementStart(14, "span", 14);
        \u0275\u0275text(15);
        \u0275\u0275elementEnd()();
        \u0275\u0275template(16, ChatSidebarComponent_div_16_Template, 2, 1, "div", 15);
        \u0275\u0275elementStart(17, "div", 16);
        \u0275\u0275namespaceSVG();
        \u0275\u0275elementStart(18, "svg", 17);
        \u0275\u0275element(19, "circle", 18)(20, "line", 19)(21, "line", 20);
        \u0275\u0275elementEnd()()();
        \u0275\u0275namespaceHTML();
        \u0275\u0275elementStart(22, "button", 21);
        \u0275\u0275listener("click", function ChatSidebarComponent_Template_button_click_22_listener() {
          \u0275\u0275restoreView(_r1);
          return \u0275\u0275resetView(ctx.toggleSidebar());
        });
        \u0275\u0275namespaceSVG();
        \u0275\u0275elementStart(23, "svg", 22);
        \u0275\u0275element(24, "rect", 23)(25, "line", 24);
        \u0275\u0275elementEnd()()()();
        \u0275\u0275namespaceHTML();
        \u0275\u0275elementStart(26, "div", 25);
        \u0275\u0275template(27, ChatSidebarComponent_div_27_Template, 4, 0, "div", 26)(28, ChatSidebarComponent_div_28_Template, 9, 1, "div", 27)(29, ChatSidebarComponent_div_29_Template, 2, 1, "div", 28)(30, ChatSidebarComponent_div_30_Template, 9, 0, "div", 29)(31, ChatSidebarComponent_div_31_Template, 3, 0, "div", 30)(32, ChatSidebarComponent_div_32_Template, 4, 0, "div", 31);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(33, "div", 32)(34, "div", 33);
        \u0275\u0275listener("click", function ChatSidebarComponent_Template_div_click_34_listener() {
          \u0275\u0275restoreView(_r1);
          return \u0275\u0275resetView(ctx.navigateToProfile());
        });
        \u0275\u0275elementStart(35, "div", 34)(36, "span");
        \u0275\u0275text(37);
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(38, "div", 35)(39, "span", 36);
        \u0275\u0275text(40);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(41, "span", 37);
        \u0275\u0275text(42, "View Profile");
        \u0275\u0275elementEnd()()();
        \u0275\u0275elementStart(43, "button", 38);
        \u0275\u0275listener("click", function ChatSidebarComponent_Template_button_click_43_listener() {
          \u0275\u0275restoreView(_r1);
          return \u0275\u0275resetView(ctx.logout());
        });
        \u0275\u0275namespaceSVG();
        \u0275\u0275elementStart(44, "svg", 17);
        \u0275\u0275element(45, "path", 39)(46, "polyline", 40)(47, "line", 41);
        \u0275\u0275elementEnd()()()();
        \u0275\u0275template(48, ChatSidebarComponent_div_48_Template, 6, 0, "div", 42);
        \u0275\u0275namespaceHTML();
        \u0275\u0275elementStart(49, "button", 43);
        \u0275\u0275listener("click", function ChatSidebarComponent_Template_button_click_49_listener() {
          \u0275\u0275restoreView(_r1);
          return \u0275\u0275resetView(ctx.toggleSidebar());
        });
        \u0275\u0275template(50, ChatSidebarComponent__svg_svg_50_Template, 4, 0, "svg", 44)(51, ChatSidebarComponent__svg_svg_51_Template, 3, 0, "svg", 44);
        \u0275\u0275elementEnd()();
      }
      if (rf & 2) {
        ...
        \u0275\u0275classProp("open", ctx.isOpen);
        \u0275\u0275advance(6);
        \u0275\u0275classProp("uploading", ctx.isUploadingResume);
        \u0275\u0275property("disabled", ctx.loading || ctx.isUploadingResume);
        \u0275\u0275advance(7);
        \u0275\u0275textInterpolate(ctx.isUploadingResume ? "Uploading..." : "Upload");
        \u0275\u0275advance();
        \u0275\u0275property("ngIf", ctx.isUploadingResume);
        \u0275\u0275advance(11);
...
var TemplateService = class _TemplateService {
   ...
   * @returns Observable with chat session details
   */
  createChatSession(templateId, isEmpty = false) {
   ...
   */
  generatePdf(templateId, resumeData, filename = "resume.pdf") {
    const payload = {
...
//# sourceMappingURL=chunk-7Q2IJ6AP.js.map
