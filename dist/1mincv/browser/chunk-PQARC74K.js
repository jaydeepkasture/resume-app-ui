...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(TemplatePreviewComponent, { className: "TemplatePreviewComponent", filePath: "src\\app\\template-gallery\\template-preview.component.ts", lineNumber: 35 });
})();
...
function TemplateGalleryComponent_div_30_div_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(1, "app-template-preview", 44);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function TemplateGalleryComponent_div_30_div_4_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(2, "rect", 47)(3, "line", 48)(4, "line", 49)(5, "rect", 50)(6, "rect", 51)(7, "rect", 52)(8, "rect", 53)(9, "rect", 54)(10, "circle", 55)(11, "circle", 56)(12, "circle", 57);
    \u0275\u0275elementEnd();
    \u0275\u0275namespaceHTML();
...
function TemplateGalleryComponent_div_30_p_12_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    const theme_r2 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" Professional ", theme_r2.type === 2 ? "interactive" : "modern", " resume template. ");
  }
}
function TemplateGalleryComponent_div_30_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(7);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(8, "div", 32)(9, "div", 33)(10, "h3");
    \u0275\u0275text(11);
    \u0275\u0275elementEnd();
    \u0275\u0275template(12, TemplateGalleryComponent_div_30_p_12_Template, 2, 1, "p", 34);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(13, "div", 35)(14, "button", 36);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(15, "svg", 37);
    \u0275\u0275element(16, "path", 38);
    \u0275\u0275elementEnd();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(17, "span");
    \u0275\u0275text(18, "Use Template");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(19, "button", 39);
    \u0275\u0275listener("click", function TemplateGalleryComponent_div_30_Template_button_click_19_listener($event) {
      const theme_r2 = \u0275\u0275restoreView(_r1).$implicit;
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.onTryEmptyTemplate($event, theme_r2));
    });
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(20, "svg", 37);
    \u0275\u0275element(21, "rect", 40)(22, "line", 41)(23, "line", 42);
    \u0275\u0275elementEnd();
    \u0275\u0275namespaceHTML();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r2.galleryViewMode === "list");
  }
}
...
var TemplateGalleryComponent = class _TemplateGalleryComponent {
  ...
  onTryEmptyTemplate(event, template) {
  ...
  checkLimitAndProceed(template, isEmpty) {
  ...
  createSession(template, isEmpty = false) {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _TemplateGalleryComponent, selectors: [["app-template-gallery"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 32, vars: 14, consts: [[3, "chatSelected", "sidebarToggled"], [1, "gallery-container"], [1, "gallery-header"], [1, "gallery-controls"], ["type", "text", "placeholder", "Search templates...", 1, "gallery-search", 3, "ngModelChange", "input", "ngModel"], [1, "gallery-filter", 3, "ngModelChange", "change", "ngModel"], ["value", "all"], ["value", "free"], ["value", "form"], [1, "view-toggle"], ["title", "Grid View", 3, "click"], ["width", "18", "height", "18", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2"], ["x", "3", "y", "3", "width", "7", "height", "7"], ["x", "14", "y", "3", "width", "7", "height", "7"], ["x", "14", "y", "14", "width", "7", "height", "7"], ["x", "3", "y", "14", "width", "7", "height", "7"], ["title", "List View", 3, "click"], ["x1", "8", "y1", "6", "x2", "21", "y2", "6"], ["x1", "8", "y1", "12", "x2", "21", "y2", "12"], ["x1", "8", "y1", "18", "x2", "21", "y2", "18"], ["x1", "3", "y1", "6", "x2", "3.01", "y2", "6"], ["x1", "3", "y1", "12", "x2", "3.01", "y2", "12"], ["x1", "3", "y1", "18", "x2", "3.01", "y2", "18"], [1, "gallery-content"], ["class", "template-card", 3, "click", 4, "ngFor", "ngForOf"], ["class", "no-results", 4, "ngIf"], [1, "template-card", 3, "click"], [1, "template-preview"], ["class", "html-preview-container", 4, "ngIf"], ["class", "form-preview-placeholder", 4, "ngIf"], ["class", "preview-placeholder", 4, "ngIf"], [1, "template-badge"], [1, "template-info"], [1, "template-text"], ["class", "template-description", 4, "ngIf"], [1, "template-actions"], [1, "select-btn"], ["width", "16", "height", "16", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2.5", "stroke-linecap", "round", "stroke-linejoin", "round"], ["d", "M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"], [1, "empty-btn", 3, "click"], ["x", "3", "y", "3", "width", "18", "height", "18", "rx", "2", "ry", "2"], ["x1", "12", "y1", "8", "x2", "12", "y2", "16"], ["x1", "8", "y1", "12", "x2", "16", "y2", "12"], [1, "html-preview-container"], [3, "htmlContent"], [1, "form-preview-placeholder"], ["width", "80", "height", "100", "viewBox", "0 0 80 100", "fill", "none", "xmlns", "http://www.w3.org/2000/svg"], ["x", "10", "y", "5", "width", "60", "height", "90", "rx", "4", "stroke", "currentColor", "stroke-width", "2", "fill", "white"], ["x1", "20", "y1", "15", "x2", "60", "y2", "15", "stroke", "currentColor", "stroke-width", "2.5", "stroke-linecap", "round"], ["x1", "20", "y1", "23", "x2", "50", "y2", "23", "stroke", "currentColor", "stroke-width", "1.5", "stroke-linecap", "round", "opacity", "0.6"], ["x", "20", "y", "32", "width", "40", "height", "6", "rx", "2", "fill", "currentColor", "opacity", "0.2"], ["x", "20", "y", "42", "width", "40", "height", "6", "rx", "2", "fill", "currentColor", "opacity", "0.2"], ["x", "20", "y", "52", "width", "25", "height", "6", "rx", "2", "fill", "currentColor", "opacity", "0.2"], ["x", "20", "y", "62", "width", "40", "height", "6", "rx", "2", "fill", "currentColor", "opacity", "0.2"], ["x", "20", "y", "72", "width", "30", "height", "6", "rx", "2", "fill", "currentColor", "opacity", "0.2"], ["cx", "17", "cy", "35", "r", "2", "fill", "currentColor", "opacity", "0.4"], ["cx", "17", "cy", "45", "r", "2", "fill", "currentColor", "opacity", "0.4"], ["cx", "17", "cy", "65", "r", "2", "fill", "currentColor", "opacity", "0.4"], [1, "form-label"], [1, "preview-placeholder"], [1, "template-description"], [1, "no-results"]], template: function TemplateGalleryComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275template(30, TemplateGalleryComponent_div_30_Template, 26, 9, "div", 24)(31, TemplateGalleryComponent_div_31_Template, 3, 0, "div", 25);
        \u0275\u0275elementEnd()();
      }
      if (rf & 2) {
        \u0275\u0275advance();
